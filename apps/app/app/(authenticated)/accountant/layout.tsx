                ...
                <Sidebar variant="inset" className="border-r border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 fixed left-0 top-16 bottom-0 w-64 overflow-y-auto">
                    <div className="p-3">
                        <div className="relative">
                            ...
                            <input
                                className="w-full rounded-md border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 pl-9 pr-3 py-2 text-sm placeholder:text-gray-500 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-1 focus:ring-green-500 text-gray-900 dark:text-white"
                                placeholder="Buscar..."
                            />
                        </div>
                    </div>
                            ...
                            <SidebarMenu>
                                {menuItems.map((item) => (
                                    <SidebarMenuItem
                                        key={item.title}
                                        className={cn(
                                            pathname.endsWith(item.href) && "text-green-500 bg-green-500/10",
