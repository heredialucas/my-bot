...
import { FileText, Calendar, Download, ChevronRight, Filter, Plus, FileCheck, BarChart } from "lucide-react";
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium">Monto Total (F22)</CardTitle>
                        <BarChart className="h-4 w-4 text-muted-foreground" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">$15.020.000</div>
                        <p className="text-xs text-muted-foreground">
                            Año Tributario 2025
                        </p>
                    </CardContent>
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Gestiona las declaraciones anuales de tus clientes
                            </CardDescription>
                        </div>
                        ...
                        <TabsContent value="pending">
                            <div className="rounded-md border">
                                <Table>
                                    ...
                                    <TableBody>
                                        {annualTaxes.filter(tax => tax.status === 'pending').map((tax) => (
                                            <TableRow key={tax.id}>
                                                ...
                                                <TableCell className="text-right">
                                                    <div className="flex justify-end gap-2">
                                                        ...
                                                        <Button
                                                            ...
                                                            asChild
                                                        >
                                                            <Link href={`/accountant/annual-taxes/${tax.id}`}>
                        ...
                        <TabsContent value="completed">
                            <div className="rounded-md border">
                                <Table>
                                    ...
                                    <TableBody>
                                        {annualTaxes.filter(tax => tax.status === 'completed').map((tax) => (
                                            <TableRow key={tax.id}>
                                                <TableCell className="font-medium">{tax.client}</TableCell>
                                                <TableCell>{tax.rut}</TableCell>
                                                <TableCell>{tax.year}</TableCell>
