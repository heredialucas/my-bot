  ...
  <div className="grid w-full min-h-screen lg:grid-cols-2 bg-white dark:bg-black text-gray-900 dark:text-white">
    ...
    <div className="hidden lg:flex flex-col justify-between bg-gray-100 dark:bg-zinc-900 p-10 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-2xl text-gray-900 dark:text-white">Cannamedicus</span>
        </Link>
        <div className="mt-6">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
            The platform for medical cannabis prescription management.
          </h1>
          <p className="text-lg mt-4 text-gray-700 dark:text-gray-300">
            Our tools help you manage cannabis prescriptions, patients, and pharmacy inventory efficiently and securely.
          </p>
        </div>
      </div>
    ...
    <div className="flex flex-col justify-center p-8 md:p-12 bg-white dark:bg-zinc-950">
      <div className="lg:hidden flex items-center justify-between mb-10">
        <Link href="/" className="flex items-center gap-2">
          <Leaf className="h-6 w-6 text-green-500" />
          <span className="font-bold text-xl text-gray-900 dark:text-white">Cannamedicus</span>
        </Link>
        <ModeToggle />
      </div>
